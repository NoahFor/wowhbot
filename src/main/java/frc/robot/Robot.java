...
public class Robot extends TimedRobot {
  ...
  CANSparkMax fLMotor, fRMotor, bLMotor, bRMotor;
  PWMSparkMax led;
  ...
  public void robotInit() {
    ...
    bLMotor = new CANSparkMax(40, MotorType.kBrushless);
    bRMotor = new CANSparkMax(7, MotorType.kBrushless);
    bLMotor.follow(fLMotor);
    bRMotor.follow(fRMotor);
    driveTrain = new DifferentialDrive(fLMotor, fRMotor);
    frank = new Joystick(0);
